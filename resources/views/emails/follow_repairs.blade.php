                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <a href="http://localhost"
                                        ...
                                        target="_blank">
                                        <img src="https://e7.pngegg.com/pngimages/948/912/png-clipart-wrench-and-screwdriver-illustration-laptop-computer-icons-maintenance-computer-repair-technician-hardware-icon-miscellaneous-angle.png"
                                            alt="Laravel Logo"
                                            style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100%;border-radius: 50%; border-style: solid; border-color: #F96E2A; height:75px;max-height:75px;width:75px;"
                            ...
                            <tr>
                                <td width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <table class="m_8671192708212740115inner-body" align="center" width="570"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <h1
                                                        ...
                                                        {{ 'สถานะการแจ้งซ่อม' }} {{ $repaors->tag_repair }}</h1>
                                                    <p
                                                        ...
                                                        {{ 'สามารถดูรายละเอียดสถานะการแจ้งซ่อมได้ที่ปุ่ม'.' '.'"ดูสถานะแจ้งซ่อม"' }}
                                                    </p>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <a href="{{ $linkReset }}"
                                                                                                        ...
                                                                                                        target="_blank">{{ 'ดูสถานะแจ้งซ่อม' }}</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                    ...
                                                    <p
                                                        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                        {{ 'ผู้แจ้งซ่อม' }} {{ $repaors->name }} <br>
                                                       
                                                           
                                                        {{ ' เจ้าหน้าที่ ' }}@if ($repaors->user_responsible){{ $repaors->nameT}}@else{{''}} @endif
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td
                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                    <table class="m_8671192708212740115footer" align="center" width="570"
                                        cellpadding="0" cellspacing="0" role="presentation"
