                        ...
                        <div class="card mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="chackname"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example"
                                                        name="chacktype" id="chacktype">
                                                        <option disabled selected>--เลือกประเภทงานซ่อม--</option>
                                                        @foreach ($Department as $name)
                                                            <option value="{{ $name->department_id }}">
                                                                {{ $name->department_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card border-danger mb-3" style="max-width: 45rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item"><b>งานบริการทั่วไป</b> ดูเเลเกี่ยวกับ
                                                    การให้ข้อมูล,
                                                    การช่วยเหลือ, หรือการแก้ไขปัญหาทั่วไป.</li>
                                                <li class="list-group-item"><b>งานประปาเเละงานท่อ</b> ดูเเลเกี่ยวกับ
                                                    การออกแบบ,
                                                    ติดตั้ง, และบำรุงรักษาระบบท่อ</li>
                                                <li class="list-group-item"><b>งานระบบไฟฟ้า</b> ดูเเลเกี่ยวกับ การออกเเบบ,
                                                    ติดตั้ง, การทดสอบ, และบำรุงรักษาระบบไฟฟ้า</li>
                                                <li class="list-group-item"><b>งานภูมิทัศน์</b>
                                        ...
                                        placeholder="*ระบุตึก ชั้น ห้อง สถานที่ให้ครบถ้วน" name="location"></textarea>  --}}
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="exampleFormControlTextarea1"
                                                    rows="1" placeholder="ระบุตึก ชั้น ห้อง สถานที่ให้ครบถ้วน"
                                                    name="location">
                                            </div>
                                            @error('location')
                                                <span role="alert" class="text-danger">
                                    ...
                                    <div class="form-group">
                                        <label for="formFileMultiple" class="form-label">ภาพประกอบ <b
                                                class="text-danger">*เลือกรูปภาพได้ไม่เกิน 5 รูปภาพ</b></label>
